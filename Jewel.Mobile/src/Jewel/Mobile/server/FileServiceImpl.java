	...
	implements FileService
{
	...
	private void overridePost(HttpServletRequest request, HttpServletResponse response)
		throws IOException, JewelMobileException
	{
		...
		if ( items.size() != 1 )
	    	throw new JewelMobileException("Unexpected number of fields in form.");
		item = (FileItem)items.get(0);
	    if (item.isFormField())
	    	throw new JewelMobileException("Unexpected non-file field in form.");
